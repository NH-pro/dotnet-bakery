...
namespace DotnetBakery.Controllers
{
    ...
    public class BreadsController : ControllerBase
    {
        ...
        public IEnumerable<Bread> GetAll() {
            Console.WriteLine("Get all bread");

            return _context.Breads.Include(Baker => Baker.bakedBy); // this joins the baker table
        }
        ...
        // nullables will be filled with NULL if they are missing from the request body 
        [HttpPut("{id}")]
